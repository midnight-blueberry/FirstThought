...
import { SectionKey } from './_sections.config';
...
import { getBaseFontName, calcFontSizeLevel } from './_utils/font';
import { clampLevel, resolveOverlayColor } from './_utils/theme';
import type { SavedSettingsPatch } from './_types';
